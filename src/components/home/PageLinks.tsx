...
export default function PageLinks() {
  return (
    <section className='bg-cerulean/50 border-cerulean/20 pop flex w-full flex-col flex-wrap items-center justify-center gap-3 rounded-lg border p-3 text-black md:flex-row'>
