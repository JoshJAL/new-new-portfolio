      ...
      <InfoCard heading='Education'>
        <div className='flex w-full flex-col gap-3'>
          <p>
            ...
            out my next step. After speaking with my sister and brother-in-law, who is also a developer, they convinced
            me to give development a shot. I signed up for a bootcamp the very next week and fell in love immediately. I
            completed the bootcamp and throughout my time in it I took all the time to learn everything I could about
            development in a short period of time, this is what people must have meant when they said &quot;If you do
            what you love you will never work a day in your life.&quot; Within a month I had my first job as a developer
            and I never looked back. This is what I was meant to do and I was not going to let it get away from me.
          </p>
            ...
            <Info label={'Covered'}>
              <div className='flex w-full flex-col gap-3'>
                <ul className='list-inside list-disc'>
                  ...
                  <li>
                    Studied the tradeoffs in data structures, including arrays, linked lists, stacks, queues, and trees
                    as well as various search algorithms and recursion.
                  </li>
                </ul>
              </div>
            </Info>
