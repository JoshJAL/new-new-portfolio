  ...
  return (
    <InfoCard id={'education'} heading='Education'>
      <section className='flex w-full flex-col gap-5'>
        ...
        <InfoCard heading={'University of Central Florida | Orlando, FL | 08/2015 - 12/2019'}>
          <Info label={'Degree'}>Bachelors of Arts in Legal Studies</Info>
        </InfoCard>
        <InfoCard heading={'Thinkful | Full Stack Web Development Bootcamp | 10/2022 - 03/2023'}>
          <Info label={'Covered'}>
