  ...
  if (red) {
    return (
      <Link
        ...
        href={href}
        onClick={onClick}
        className={`${additionalClasses ? additionalClasses : fit ? 'w-fit' : 'w-full'} nice-hover-no-shadow cursor-pointer rounded-lg border border-red-600/20 bg-red-600/50 px-3 py-2 text-center font-semibold text-white backdrop-blur-sm transition-all duration-300 ease-in-out hover:border-red-800/20 hover:bg-red-800/50 ${roboto.className} pop`}
      >
        {children}
      </Link>
    );
