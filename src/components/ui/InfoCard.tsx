...
export default function InfoCard({ children, colorSwap, heading, id }: Props) {
  ...
  return (
    <div
      id={id}
      className={`divide-carribean-current bg-desert-sand divide-y overflow-hidden rounded-lg text-black shadow-[3px_3px_0px_rgba(255,255,255,1)] ${roboto.className}`}
    >
