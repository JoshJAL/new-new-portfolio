...
export default function Page() {
  return (
    <article className='flex w-full flex-col gap-12'>
      ...
      <section className='flex w-full flex-col gap-6'>
        ...
        <GlassPanel tint='cerulean' className='flex flex-col gap-3'>
          ...
          <p>
            ...
            what I went to school for I found that I was significantly happier doing literally anything other than law.
            However, I knew that I wanted to do more and was willing to put in an immeasurable amount of work to get
            there. I just had to figure out what that was.
          </p>
          <p>
            ...
            graduated from the bootcamp with a strong foundation in web development, and I was ready to take on the
            world.
          </p>
          <p>
      ...
      <section className='flex w-full flex-col gap-6'>
        <SectionHeading id='hobbies'>Hobbies</SectionHeading>
        <GlassPanel tint='dark-cyan' className='flex flex-col gap-3'>
          <p>
          ...
          <p>
            ...
            them through our shared interests and now I am attending their weddings and taking them on adventures. When
            I do get to play these days I either jump on Valorant with my friends, play binding of Isaac until my eyes
            bleed or foster a hidden gambling addiction with Balatro.
          </p>
          <p>
      ...
      <section className='flex w-full flex-col gap-6'>
        ...
        <GlassPanel tint='caribbean' className='flex flex-col gap-3'>
          ...
          <p>
            When I was 14 I worked in a textile factory cutting pallets of fabric. That was a lot of fun and holds no
          ...
          <p>
            ...
            to pursue law. Family law is brutal, you get a front row seat to two people who used to love each other tear
            each other limb from limb using the very things they initially trusted each other with. Sometimes they would
            weaponize their children while they were in the room themselves, something that I find morally
            reprehensible. This was a fantastic opportunity, and incredible learning experience that I am ever grateful
            for and something that I learned from deeply, both about myself and about the law.
          </p>
          <p>
            After learning to code I worked for a company known as Rob Graham Enterprises. I learned so much so quickly
            here. The one other developer that I worked with here was able to teach me so much in such a short amount of
          ...
          <p>
            ...
            finances with no guarantee of a paycheck is not for the faint of heart. I built website and infrastructure
